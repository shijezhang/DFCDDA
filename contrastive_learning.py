...
def similarity_contrastive(drug_simlilarity_matrix, disease_simlilarity_matrix, drug_feature, disease_feature, args):
    drug_pos_indice, drug_neg_indice, disease_pos_indice, disease_neg_indice = get_pos_neg_indice(
...
def inter_contrastive(drug_simlilarity_matrix, disease_simlilarity_matrix, drug_feature1, disease_feature1,
                      drug_feature2, disease_feature2, args):
